...
__global__ void
kernel_statemonitor_2_codeobject_1(
    int _num_indices,
    int32_t* indices,
...
void _run_statemonitor_2_codeobject_1()
{
    using namespace brian;
...
if (_num__array_statemonitor_2__indices > 1024)
{
    printf("ERROR in statemonitor_2: Too many neurons recorded. Due to a bug (brian-team/brian2cuda#50), "
        ...
        CUDA_SAFE_CALL(
                cudaFuncGetAttributes(&funcAttrib, kernel_statemonitor_2_codeobject_1)
                );
...
{
    kernel_statemonitor_2_codeobject_1<<<1, _num__array_statemonitor_2__indices>>>(
    ...
    CUDA_CHECK_ERROR("kernel_statemonitor_2_codeobject_1");
}
    ...
    statemonitor_2_codeobject_1_profiling_info += _run_time;
}
