...
void _run_synapses_2_pre_initialise_queue()
{
    ...
    _dynamic_array_synapses_2_delay = dev_dynamic_array_synapses_2_delay;
    ...
    for(int i = 0; i < num_pre_post_blocks; i++)
    {
        ...
        if (!scalar_delay)
        {
            ...
            for (int bundle_idx = 0; bundle_idx < num_unique_elements; bundle_idx++)
            {
                ...
                if (num_synapses > synapses_2_pre_max_bundle_size)
                    synapses_2_pre_max_bundle_size = num_synapses;
    ...
    else  // not scalar_delay
    {
        ...
        synapses_2_pre_mean_bundle_size = sum_bundle_sizes / num_bundle_ids;
