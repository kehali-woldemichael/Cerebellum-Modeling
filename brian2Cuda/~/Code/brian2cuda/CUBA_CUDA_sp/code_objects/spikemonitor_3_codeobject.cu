...
__global__ void _run_spikemonitor_3_codeobject_init()
{
...
__global__ void
kernel_spikemonitor_3_codeobject(
    int neurongroup_N,
    int32_t* count,
    // KERNEL_PARAMETERS
...
void _run_spikemonitor_3_codeobject()
{
    ...
    if (first_run)
    {
_run_spikemonitor_3_codeobject_init<<<1,1>>>();

CUDA_CHECK_ERROR("_run_spikemonitor_3_codeobject_init");
num_blocks = 1;
num_threads = 1;
        ...
        CUDA_SAFE_CALL(
                cudaOccupancyMaxActiveBlocksPerMultiprocessor(&max_active_blocks,
                    kernel_spikemonitor_3_codeobject, num_threads, 0)
                );
        ...
        CUDA_SAFE_CALL(
                cudaFuncGetAttributes(&funcAttrib, kernel_spikemonitor_3_codeobject)
                );
        ...
        {
            printf("INFO kernel_spikemonitor_3_codeobject\n"
                   "\t%u blocks\n"
                   "\t%u threads\n"
...
kernel_spikemonitor_3_codeobject<<<num_blocks, num_threads>>>(
        _num_spikespace-1,
...
CUDA_CHECK_ERROR("kernel_spikemonitor_3_codeobject");


}

__global__ void _run_debugmsg_spikemonitor_3_codeobject_kernel(
    // KERNEL_PARAMETERS
    const double _value_array_defaultclock_t,
	int32_t* _ptr_array_spikemonitor_3_count,
	int32_t* _ptr_array_neurongroup_1__spikespace,
...
__global__ void _count_spikemonitor_3_codeobject_kernel(
    int* dev_num_events,
    // KERNEL_PARAMETERS
    const double _value_array_defaultclock_t,
	int32_t* _ptr_array_spikemonitor_3_count,
...
__global__ void _copy_spikemonitor_3_codeobject_kernel(
...
void _copyToHost_spikemonitor_3_codeobject()
{
    using namespace brian;
    ...
    _count_spikemonitor_3_codeobject_kernel<<<1,1>>>(
        dev_num_events,
        // HOST_PARAMETERS
        _array_defaultclock_t[0],
			dev_array_spikemonitor_3_count,
    ...
    CUDA_CHECK_ERROR("_count_spikemonitor_3_codeobject_kernel");
...
void _debugmsg_spikemonitor_3_codeobject()
{
    ...
    _run_debugmsg_spikemonitor_3_codeobject_kernel<<<1,1>>>(
            // HOST_PARAMETERS
            _array_defaultclock_t[0],
			dev_array_spikemonitor_3_count,
			dev_array_neurongroup_1__spikespace[current_idx_array_neurongroup_1__spikespace],
    ...
    CUDA_CHECK_ERROR("_run_debugmsg_spikemonitor_3_codeobject_kernel");
}
