...
__global__ void
kernel_ratemonitor_3_codeobject(
...
num_blocks = 1;
        ...
        CUDA_SAFE_CALL(
                cudaOccupancyMaxActiveBlocksPerMultiprocessor(&max_active_blocks,
                    kernel_ratemonitor_3_codeobject, num_threads, 0)
                );
        ...
        CUDA_SAFE_CALL(
                cudaFuncGetAttributes(&funcAttrib, kernel_ratemonitor_3_codeobject)
                );
        ...
        {
            printf("INFO kernel_ratemonitor_3_codeobject\n"
                   "\t%u blocks\n"
                   "\t%u threads\n"
...
kernel_ratemonitor_3_codeobject<<<num_blocks, num_threads>>>(
...
CUDA_CHECK_ERROR("kernel_ratemonitor_3_codeobject");
