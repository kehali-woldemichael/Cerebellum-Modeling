#include "objects.h"
#include "code_objects/spikemonitor_2_codeobject_1.h"
...
__global__ void _run_spikemonitor_2_codeobject_1_init()
{
...
__global__ void
kernel_spikemonitor_2_codeobject_1(
    int neurongroup_N,
    int32_t* count,
    // KERNEL_PARAMETERS
	...
	int32_t* _ptr_array_neurongroup_3_i
    )
{
    ...
    {
        int32_t spiking_neuron = _ptr_array_neurongroup_3__spikespace[i];
        if(spiking_neuron != -1)
        {
...
void _run_spikemonitor_2_codeobject_1()
{
    using namespace brian;
    ...
    const int _numcount = 10;
		const int _num_spikespace = 11;
		int32_t* const _array_spikemonitor_2_i = thrust::raw_pointer_cast(&dev_dynamic_array_spikemonitor_2_i[0]);
		const int _numi = dev_dynamic_array_spikemonitor_2_i.size();
		const int _numN = 1;
		double* const _array_spikemonitor_2_t = thrust::raw_pointer_cast(&dev_dynamic_array_spikemonitor_2_t[0]);
    ...
    if (first_run)
    {
_run_spikemonitor_2_codeobject_1_init<<<1,1>>>();

CUDA_CHECK_ERROR("_run_spikemonitor_2_codeobject_1_init");
num_blocks = 1;
num_threads = 1;
        ...
        CUDA_SAFE_CALL(
                cudaOccupancyMaxActiveBlocksPerMultiprocessor(&max_active_blocks,
                    kernel_spikemonitor_2_codeobject_1, num_threads, 0)
                );
        ...
        CUDA_SAFE_CALL(
                cudaFuncGetAttributes(&funcAttrib, kernel_spikemonitor_2_codeobject_1)
                );
        ...
        {
            printf("INFO kernel_spikemonitor_2_codeobject_1\n"
                   "\t%u blocks\n"
                   "\t%u threads\n"
...
kernel_spikemonitor_2_codeobject_1<<<num_blocks, num_threads>>>(
        _num_spikespace-1,
        ...
        _array_defaultclock_t[0],
			...
			_array_spikemonitor_2_i,
			_numi,
			dev_array_spikemonitor_2_N,
			_array_spikemonitor_2_t,
			_numt,
			dev_array_spikemonitor_2__source_idx,
			dev_array_neurongroup_3_i);

CUDA_CHECK_ERROR("kernel_spikemonitor_2_codeobject_1");
    ...
    spikemonitor_2_codeobject_1_profiling_info += _run_time;
}

__global__ void _run_debugmsg_spikemonitor_2_codeobject_1_kernel(
    // KERNEL_PARAMETERS
    const double _value_array_defaultclock_t,
	int32_t* _ptr_array_spikemonitor_2_count,
	int32_t* _ptr_array_neurongroup_3__spikespace,
...
__global__ void _count_spikemonitor_2_codeobject_1_kernel(
    int* dev_num_events,
    // KERNEL_PARAMETERS
    const double _value_array_defaultclock_t,
	int32_t* _ptr_array_spikemonitor_2_count,
...
__global__ void _copy_spikemonitor_2_codeobject_1_kernel(
...
void _copyToHost_spikemonitor_2_codeobject_1()
{
    using namespace brian;
    ...
    _count_spikemonitor_2_codeobject_1_kernel<<<1,1>>>(
        dev_num_events,
        // HOST_PARAMETERS
        _array_defaultclock_t[0],
			dev_array_spikemonitor_2_count,
    ...
    CUDA_CHECK_ERROR("_count_spikemonitor_2_codeobject_1_kernel");
    ...
    _copy_spikemonitor_2_codeobject_1_kernel<<<1,1>>>(
        thrust::raw_pointer_cast(&dev_dynamic_array_spikemonitor_2_i[0]),
        thrust::raw_pointer_cast(&dev_dynamic_array_spikemonitor_2_t[0]),
        0          );

    CUDA_CHECK_ERROR("_copy_spikemonitor_2_codeobject_1_kernel");
}

void _debugmsg_spikemonitor_2_codeobject_1()
{
    using namespace brian;
    ...
    _run_debugmsg_spikemonitor_2_codeobject_1_kernel<<<1,1>>>(
            // HOST_PARAMETERS
            _array_defaultclock_t[0],
			dev_array_spikemonitor_2_count,
			dev_array_neurongroup_3__spikespace[current_idx_array_neurongroup_3__spikespace],
    ...
    CUDA_CHECK_ERROR("_run_debugmsg_spikemonitor_2_codeobject_1_kernel");
}
