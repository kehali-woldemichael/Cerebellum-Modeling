...
size_t used_device_memory_start = used_device_memory;
    ...
    ///// HOST_CONSTANTS ///////////
    int32_t* const _array_synapses_1_N_incoming = thrust::raw_pointer_cast(&dev_dynamic_array_synapses_1_N_incoming[0]);
		const int _numN_incoming = dev_dynamic_array_synapses_1_N_incoming.size();
		...
		int32_t* const _array_synapses_1_N_outgoing = thrust::raw_pointer_cast(&dev_dynamic_array_synapses_1_N_outgoing[0]);
		const int _numN_outgoing = dev_dynamic_array_synapses_1_N_outgoing.size();
		const int _numN = 1;
    ...
    const int32_t newsize = _dynamic_array_synapses_1__synaptic_pre.size();
            ...
            THRUST_CHECK_ERROR(
                    dev_dynamic_array_synapses_1_delay_1.resize(newsize)
                    );
            ...
            THRUST_CHECK_ERROR(
                    dev_dynamic_array_synapses_1_w_CFPKJ.resize(newsize)
                    );
            _dynamic_array_synapses_1_w_CFPKJ.resize(newsize);
