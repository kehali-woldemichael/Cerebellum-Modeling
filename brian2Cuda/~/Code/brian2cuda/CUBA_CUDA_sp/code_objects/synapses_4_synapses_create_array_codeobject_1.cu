...
void _run_synapses_4_synapses_create_array_codeobject_1()
{
...
int32_t* __restrict  _ptr_array_synapses_4_targets_1 = _array_synapses_4_targets_1;
int32_t* __restrict  _ptr_array_synapses_4__synaptic_post = _array_synapses_4__synaptic_post;
int32_t* __restrict  _ptr_array_synapses_4_sources_1 = _array_synapses_4_sources_1;
int32_t*   _ptr_array_synapses_4_N = _array_synapses_4_N;


for (int _idx=0; _idx<_numsources; _idx++) {
        
    const int32_t sources = _ptr_array_synapses_4_sources_1[_idx];
    const int32_t targets = _ptr_array_synapses_4_targets_1[_idx];
