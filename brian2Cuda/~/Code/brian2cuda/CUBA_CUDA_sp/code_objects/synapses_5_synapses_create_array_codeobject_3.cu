...
void _run_synapses_5_synapses_create_array_codeobject_3()
{
...
size_t used_device_memory_start = used_device_memory;
    ...
    ///// HOST_CONSTANTS ///////////
    int32_t* const _array_synapses_5_N_outgoing = thrust::raw_pointer_cast(&dev_dynamic_array_synapses_5_N_outgoing[0]);
		const int _numN_outgoing = dev_dynamic_array_synapses_5_N_outgoing.size();
		...
		int32_t* const _array_synapses_5_N_incoming = thrust::raw_pointer_cast(&dev_dynamic_array_synapses_5_N_incoming[0]);
		const int _numN_incoming = dev_dynamic_array_synapses_5_N_incoming.size();
...
int32_t* __restrict  _ptr_array_synapses_5_targets_3 = _array_synapses_5_targets_3;
int32_t* __restrict  _ptr_array_synapses_5__synaptic_post = _array_synapses_5__synaptic_post;
int32_t* __restrict  _ptr_array_synapses_5_sources_3 = _array_synapses_5_sources_3;
int32_t*   _ptr_array_synapses_5_N = _array_synapses_5_N;


for (int _idx=0; _idx<_numsources; _idx++) {
        
    const int32_t sources = _ptr_array_synapses_5_sources_3[_idx];
    const int32_t targets = _ptr_array_synapses_5_targets_3[_idx];
...
const int32_t newsize = _dynamic_array_synapses_5__synaptic_pre.size();
        ...
        THRUST_CHECK_ERROR(
                dev_dynamic_array_synapses_5_delay_1.resize(newsize)
                );
        _dynamic_array_synapses_5_delay_1.resize(newsize);
        THRUST_CHECK_ERROR(
                dev_dynamic_array_synapses_5_delay.resize(newsize)
                );
        _dynamic_array_synapses_5_delay.resize(newsize);
        THRUST_CHECK_ERROR(
                dev_dynamic_array_synapses_5_w_GRBS.resize(newsize)
                );
        _dynamic_array_synapses_5_w_GRBS.resize(newsize);
CUDA_CHECK_MEMORY();
