#include "objects.h"
#include "code_objects/neurongroup_2_resetter_codeobject_1.h"
...
__global__ void
kernel_neurongroup_2_resetter_codeobject_1(
    int _N,
...
void _run_neurongroup_2_resetter_codeobject_1()
{
    using namespace brian;
    ...
    if (first_run)
    {
        ...
        CUDA_SAFE_CALL(
                cudaOccupancyMaxPotentialBlockSize(&min_num_threads, &num_threads,
                    kernel_neurongroup_2_resetter_codeobject_1, 0, 0)  // last args: dynamicSMemSize, blockSizeLimit
                );
        ...
        CUDA_SAFE_CALL(
                cudaOccupancyMaxActiveBlocksPerMultiprocessor(&max_active_blocks,
                    kernel_neurongroup_2_resetter_codeobject_1, num_threads, 0)
                );
        ...
        CUDA_SAFE_CALL(
                cudaFuncGetAttributes(&funcAttrib, kernel_neurongroup_2_resetter_codeobject_1)
                );
        ...
        {
            printf("INFO kernel_neurongroup_2_resetter_codeobject_1\n"
                   "\t%u blocks\n"
                   "\t%u threads\n"
    ...
    kernel_neurongroup_2_resetter_codeobject_1<<<num_blocks, num_threads>>>(
            _N,
            num_threads,
            ///// HOST_PARAMETERS /////
    ...
    CUDA_CHECK_ERROR("kernel_neurongroup_2_resetter_codeobject_1");
    ...
    neurongroup_2_resetter_codeobject_1_profiling_info += _run_time;
}
