...
class RandomNumberBuffer
{
    ...
    // poissongroup_1_thresholder_codeobject
    int num_per_cycle_rand_poissongroup_1_thresholder_codeobject;
    int rand_interval_poissongroup_1_thresholder_codeobject;
    int num_per_gen_rand_poissongroup_1_thresholder_codeobject;
    int idx_rand_poissongroup_1_thresholder_codeobject;
    int rand_floats_per_obj_poissongroup_1_thresholder_codeobject;

    // poissongroup_thresholder_codeobject
    int num_per_cycle_rand_poissongroup_thresholder_codeobject;
    int rand_interval_poissongroup_thresholder_codeobject;
    int num_per_gen_rand_poissongroup_thresholder_codeobject;
    int idx_rand_poissongroup_thresholder_codeobject;
    int rand_floats_per_obj_poissongroup_thresholder_codeobject;
